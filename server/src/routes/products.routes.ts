...
// Add new product
router.post("/add", authMiddleware, requireAdmin, async (req: AuthenticatedRequest, res) => {
  try {
...
// Update product
router.put("/:id", authMiddleware, requireAdmin, async (req: AuthenticatedRequest, res) => {
  try {
    const { id } = req.params;
